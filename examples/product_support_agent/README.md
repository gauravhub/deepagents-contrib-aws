...
| Skill | File | Covers |
|-------|------|--------|
| Electronics Support | `skills/electronics-support.md` | TVs, laptops, smartphones, headphones — power, connectivity, display, battery, audio issues |
| Healthcare Products | `skills/healthcare-products.md` | BP monitors, pulse oximeters, thermometers, fitness trackers — usage, calibration, error codes, safety |
| Finance Products | `skills/finance-products.md` | Payment terminals, card readers, POS systems, banking apps — transactions, connectivity, security |
